...
namespace Spotlight.Models
{
    ...
    {
        private static List<NewsPost> allNewsPosts = new List<NewsPost> {
        ...
        public void AddNews(NewsPost n) => allNewsPosts.Add(n);

        public IEnumerable<NewsPost> AllNewsPosts => allNewsPosts;
    }
}